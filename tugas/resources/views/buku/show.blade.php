    ...
    <div class="col-md-4">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body d-grid gap-2">
                ...
                {{-- LAKUKAN POIN B: Menyesuaikan Form Delete dengan Instruksi Tugas --}}
...
{{-- PENGGABUNGAN POIN B & C SESUAI STRUKTUR TUGAS --}}
@push('scripts')
<script>
    // LAKUKAN POIN B: SweetAlert confirmation untuk delete
